...
def get_datasets(
  ...
  train_data = get_raw_dataset(train_ds_builder, config.dataset_name, 'train')

  if config.eval_dataset_name:
    eval_ds_builder = tfds.builder(config.eval_dataset_name)
  else:
    eval_ds_builder = train_ds_builder
  eval_data = get_raw_dataset(eval_ds_builder, config.dataset_name, config.eval_split)
  ...
  sp_tokenizer = tokenizer.load_or_train_tokenizer(
      ...
      character_coverage=config.spm.character_coverage,
  )
